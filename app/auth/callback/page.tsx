        ...
        if (data.session?.user) {
          ...
          try {
            ...
            if (profileError) {
              ...
              // Default to customer if profile not found or RLS error occurs
            ...
            console.error("RLS recursion error:", rlsError)
            // Default to customer if RLS recursion error occurs
            router.push("/customer")
          }
        } else {
